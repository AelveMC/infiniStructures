# Made by Aelve
# Called by portal/functions/z_left_corner.mcfunction
...
execute unless entity @e[type=minecraft:marker,tag=portal.edge,distance=..0.1] positioned ~ ~1 ~ run function portal:z_check_up
