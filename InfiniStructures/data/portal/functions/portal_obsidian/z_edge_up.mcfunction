...
execute if block ~ ~ ~ minecraft:obsidian positioned ~ ~1 ~ run function portal:portal_obsidian/z_edge_up

# Locate top edge, skipping corner.
execute if block ~ ~ ~ minecraft:obsidian if block ~ ~1 ~-1 minecraft:obsidian positioned ~ ~1 ~-1 run function portal:portal_obsidian/z_edge_left