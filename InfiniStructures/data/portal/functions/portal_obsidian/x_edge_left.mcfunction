...
execute if block ~ ~ ~ minecraft:obsidian positioned ~-1 ~ ~ run function portal:portal_obsidian/x_edge_left

# Locate side edge, skipping corner.
execute if block ~ ~ ~ minecraft:obsidian if block ~-1 ~-1 ~ minecraft:obsidian positioned ~-1 ~-1 ~ run function portal:portal_obsidian/x_edge_down
