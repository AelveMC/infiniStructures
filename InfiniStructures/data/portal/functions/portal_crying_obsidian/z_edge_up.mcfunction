...
# Checks right side of frame is complete (z axis).
...
execute if block ~ ~ ~ minecraft:crying_obsidian positioned ~ ~1 ~ run function portal:portal_crying_obsidian/z_edge_up

# Locate top edge, skipping corner.
execute if block ~ ~ ~ minecraft:crying_obsidian if block ~ ~1 ~-1 minecraft:crying_obsidian positioned ~ ~1 ~-1 run function portal:portal_crying_obsidian/z_edge_left