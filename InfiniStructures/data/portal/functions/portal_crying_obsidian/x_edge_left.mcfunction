...
execute if block ~ ~ ~ minecraft:crying_obsidian positioned ~-1 ~ ~ run function portal:portal_crying_obsidian/x_edge_left

# Locate side edge, skipping corner.
execute if block ~ ~ ~ minecraft:crying_obsidian if block ~-1 ~-1 ~ minecraft:crying_obsidian positioned ~-1 ~-1 ~ run function portal:portal_crying_obsidian/x_edge_down
