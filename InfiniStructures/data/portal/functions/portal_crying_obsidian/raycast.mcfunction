...
execute if block ~ ~ ~ minecraft:air positioned ^ ^ ^0.1 run function portal:portal_crying_obsidian/raycast
...
execute if block ~ ~ ~ fire positioned ~1 ~-1 ~ run function portal:portal_crying_obsidian/x_edge_right
execute if block ~ ~ ~ fire positioned ~ ~-1 ~1 run function portal:portal_crying_obsidian/z_edge_right
