# Made by Aelve
# Called by portal/functions/x_check_up.mcfunction
...
execute if score @s isempty matches 0 positioned ~-1 ~1 ~ if entity @e[type=minecraft:marker,tag=portal.edge,distance=..0.1] positioned ~1 ~-1 ~ if entity @e[type=minecraft:marker,tag=portal.edge,distance=..0.1] positioned ~-1 ~ ~ run function portal:x_fill_portal
